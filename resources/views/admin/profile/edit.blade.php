@extends('admin.layouts.app', ['activePage' => 'user', 'title' => 'Light Bootstrap Dashboard Laravel by Creative Tim & UPDIVISION', 'navName' => 'User Profile', 'activeButton' => 'laravel'])
                    ...
                    <div class="card col-md-8">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('profile.password') }}">
                                ...
                                @include('admin.alerts.error_self_update', ['key' => 'not_allow_password'])
