...
@section('content')
    ...
    <!-- HEADER -->
    <header class="mb-30" style="background-image: url(img/fundo-alugue-seu-imovel.jpg)">
      <div class="container h-100 pt-15">
        ...
        <div class="row mb-30 h-100 text-center texto-branco">
          <div class="col">
            <h1 class="mb-15"><strong>APROVEITE A OPORTUNIDADE</strong></h1>
            <h2 class="texto-fino texto-g">Alugue seu imóvel, aproveite e deixe o resto com a gente!</h2>
          </div>
        </div>
      </div>
    </header>
    ...
    <section>
      <div class="container">
        <div class="row text-center">
          <div class="col">
            <h2 class="mb-10"><strong>COMO FAZEMOS ISSO?</strong></h2>
            <h3 class="texto-g mb-15">Confira as vantagens</h3>
          </div>
        </div>
        <div class="row mb-15">
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-sm-6">
            <form>
              ...
              <div class="form-group form-inline form-quantidade justify-content-between align-items-center">
                <label class="texto-m">Número de alojamentos</label>
                <div>
                  <a href="#!" class="btn btn-p btn-ico"><i class="uil uil-minus"></i></a>
                  <input type="text" name="Qantidade" placeholder="0">
                  <a href="#!" class="btn btn-p btn-ico"><i class="uil uil-plus"></i></a>
                </div>
              </div>
              <div class="form-group">
