...
@section('content')
    ...
    <!-- HEADER -->
    <header class="mb-30" style="background-image: url(img/fundo-como-funciona.jpg)">
    ...
    <!-- BLOCO --->
    <section class="text-center etapas">
      <div class="container">
        <div class="row justify-content-center align-items-center">
          ...
          <div class="col-12 col-sm-4">
            <img src="img/etapas/etapa-localizacao.jpg">
          </div>
        </div>
        <div class="row justify-content-center align-items-center">
          <div class="col-12 col-sm-4">
          ...
          <div class="col-12 col-sm-4">
            <img src="img/etapas/etapa-datas.jpg">
          </div>
        </div>
        <div class="row justify-content-center align-items-center">
          <div class="col-12 col-sm-4">
          ...
          <div class="col-12 col-sm-4">
            <img src="img/etapas/etapa-hospedes.jpg">
          </div>
        </div>
        <div class="row justify-content-center align-items-center">
          <div class="col-12 col-sm-4">
          ...
          <div class="col-12 col-sm-4">
            <img src="img/etapas/etapa-hospedagem.jpg">
          </div>
        </div>
        <div class="row justify-content-center align-items-center">
          <div class="col-12 col-sm-4">
          ...
          <div class="col-12 col-sm-4">
            <img src="img/etapas/etapa-servicos.jpg">
          </div>
        </div>
        <div class="row justify-content-center align-items-center">
          ...
          <div class="col-12 col-sm-4">
            <img src="img/etapas/etapa-reserva.jpg">
          </div>
        </div>
        <div class="row justify-content-center align-items-center">
          <div class="col-12 col-sm-4">
          ...
          <div class="col-12 col-sm-4">
            <img src="img/etapas/etapa-aproveite.jpg">
          </div>
        </div>
      </div>
    </section>
