...
<section class="mb-30">
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <p class="texto-m texto-ret"><strong>O estúdio em Curitiba tem 1 quarto(s)</strong></p>
                <h2 class="mb-5"><strong>Título do anúncio</strong></h2>
                <p class="texto-m">6 hóspedes • 2 quartos • 3 camas • 2 banheiros • 29m²</p>
                <h4 class="texto-m d-flex gap-5 mb-5"><i class="icone-m uil uil-star"></i> <strong>9,5</strong> (200)</h4>
