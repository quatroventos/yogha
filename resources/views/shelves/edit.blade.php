@extends('layouts.app', ['activePage' => 'user', 'title' => 'Yogha - Admin v1.0.0 - Prateleiras', 'navName' => 'Editar prateleira', 'activeButton' => 'prateleiras'])
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <!-- -->
                                        ...
                                        <div class="form-group{{ $errors->has('shelfLayoutId') ? ' has-danger' : '' }}">
                                            ...
                                            @include('alerts.feedback', ['field' => 'shelfLayoutId'])
                                        </div>
                                        ...
                                        <div class="form-group{{ $errors->has('shelfFilterId') ? ' has-danger' : '' }}">
                                            ...
                                            @include('alerts.feedback', ['field' => 'shelfFilterId'])
                                        </div>
